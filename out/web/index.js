...
Module['FS_createPath']("/res", "sprites", true, true);
    ...
    loadPackage({"files": [{"filename": "/res/aseprite/teste.aseprite", "start": 0, "end": 450}, {"filename": "/res/fonts/monogram-extended.ttf", "start": 450, "end": 59458}, {"filename": "/res/shaders/default.wgsl", "start": 59458, "end": 60584}, {"filename": "/res/sprites/Platforms.aseprite", "start": 60584, "end": 62087}, {"filename": "/res/sprites/atlas.aseprite", "start": 62087, "end": 62864}, {"filename": "/res/sprites/atlas.png", "start": 62864, "end": 66874}, {"filename": "/res/sprites/background.aseprite", "start": 66874, "end": 74124}, {"filename": "/res/sprites/background.png", "start": 74124, "end": 82374}, {"filename": "/res/sprites/bar.png", "start": 82374, "end": 82618}, {"filename": "/res/sprites/cloud.png", "start": 82618, "end": 83015}, {"filename": "/res/sprites/coin.png", "start": 83015, "end": 83227}, {"filename": "/res/sprites/heart.png", "start": 83227, "end": 83431}, {"filename": "/res/sprites/heatlh_bar.aseprite", "start": 83431, "end": 83896}, {"filename": "/res/sprites/how_to_play.png", "start": 83896, "end": 84879}, {"filename": "/res/sprites/kat.png", "start": 84879, "end": 85792}, {"filename": "/res/sprites/live.png", "start": 85792, "end": 86038}, {"filename": "/res/sprites/live_animation.png", "start": 86038, "end": 86137}, {"filename": "/res/sprites/map.png", "start": 86137, "end": 86504}, {"filename": "/res/sprites/milk.aseprite", "start": 86504, "end": 86966}, {"filename": "/res/sprites/milk.png", "start": 86966, "end": 87271}, {"filename": "/res/sprites/name.png", "start": 87271, "end": 88848}, {"filename": "/res/sprites/platform-1.aseprite", "start": 88848, "end": 89221}, {"filename": "/res/sprites/platform-1.png", "start": 89221, "end": 89361}, {"filename": "/res/sprites/platform.png", "start": 89361, "end": 89690}, {"filename": "/res/sprites/play.png", "start": 89690, "end": 90318}, {"filename": "/res/sprites/slime-2.png", "start": 90318, "end": 90643}, {"filename": "/res/sprites/slime.png", "start": 90643, "end": 90940}, {"filename": "/res/sprites/star.png", "start": 90940, "end": 91184}, {"filename": "/res/sprites/steam.png", "start": 91184, "end": 91746}, {"filename": "/res/sprites/tileset.png", "start": 91746, "end": 93020}, {"filename": "/res/sprites/twitch.png", "start": 93020, "end": 93382}, {"filename": "/res/sprites/youtube.png", "start": 93382, "end": 93727}], "remote_package_size": 93727});

  })();

// end include: /tmp/tmp5ve_qc1b.js
// include: /tmp/tmpbbsw1ev6.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpbbsw1ev6.js
// include: /tmp/tmpfpc9bold.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpfpc9bold.js
...
var ASM_CONSTS = {
 ...
 171338: () => { return Module['SDL3'].audioContext.sampleRate; },  
 ...
 173230: ($0, $1, $2, $3) => { var SDL3 = Module['SDL3']; SDL3.audio_playback.scriptProcessorNode = SDL3.audioContext['createScriptProcessor']($1, 0, $0); SDL3.audio_playback.scriptProcessorNode['onaudioprocess'] = function (e) { if ((SDL3 === undefined) || (SDL3.audio_playback === undefined)) { return; } if (SDL3.audio_playback.silenceTimer !== undefined) { clearInterval(SDL3.audio_playback.silenceTimer); SDL3.audio_playback.silenceTimer = undefined; SDL3.audio_playback.silenceBuffer = undefined; } SDL3.audio_playback.currentPlaybackBuffer = e['outputBuffer']; dynCall('ip', $2, [$3]); }; SDL3.audio_playback.scriptProcessorNode['connect'](SDL3.audioContext['destination']); if (SDL3.audioContext.state === 'suspended') { SDL3.audio_playback.silenceBuffer = SDL3.audioContext.createBuffer($0, $1, SDL3.audioContext.sampleRate); SDL3.audio_playback.silenceBuffer.getChannelData(0).fill(0.0); var silence_callback = function() { if ((typeof navigator.userActivation) !== 'undefined') { if (navigator.userActivation.hasBeenActive) { SDL3.audioContext.resume(); } } SDL3.audio_playback.currentPlaybackBuffer = SDL3.audio_playback.silenceBuffer; dynCall('ip', $2, [$3]); SDL3.audio_playback.currentPlaybackBuffer = undefined; }; SDL3.audio_playback.silenceTimer = setInterval(silence_callback, ($1 / SDL3.audioContext.sampleRate) * 1000); } },  
 174546: ($0) => { var SDL3 = Module['SDL3']; if ($0) { if (SDL3.audio_recording.silenceTimer !== undefined) { clearInterval(SDL3.audio_recording.silenceTimer); } if (SDL3.audio_recording.stream !== undefined) { var tracks = SDL3.audio_recording.stream.getAudioTracks(); for (var i = 0; i < tracks.length; i++) { SDL3.audio_recording.stream.removeTrack(tracks[i]); } } if (SDL3.audio_recording.scriptProcessorNode !== undefined) { SDL3.audio_recording.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) {}; SDL3.audio_recording.scriptProcessorNode.disconnect(); } if (SDL3.audio_recording.mediaStreamNode !== undefined) { SDL3.audio_recording.mediaStreamNode.disconnect(); } SDL3.audio_recording = undefined; } else { if (SDL3.audio_playback.scriptProcessorNode != undefined) { SDL3.audio_playback.scriptProcessorNode.disconnect(); } if (SDL3.audio_playback.silenceTimer !== undefined) { clearInterval(SDL3.audio_playback.silenceTimer); } SDL3.audio_playback = undefined; } if ((SDL3.audioContext !== undefined) && (SDL3.audio_playback === undefined) && (SDL3.audio_recording === undefined)) { SDL3.audioContext.close(); SDL3.audioContext = undefined; } },  
 175702: ($0, $1) => { var SDL3 = Module['SDL3']; var buf = SDL3.CPtrToHeap32Index($0); var numChannels = SDL3.audio_playback.currentPlaybackBuffer['numberOfChannels']; for (var c = 0; c < numChannels; ++c) { var channelData = SDL3.audio_playback.currentPlaybackBuffer['getChannelData'](c); if (channelData.length != $1) { throw 'Web Audio playback buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } for (var j = 0; j < $1; ++j) { channelData[j] = HEAPF32[buf + (j * numChannels + c)]; } } },  
 176235: ($0, $1) => { var SDL3 = Module['SDL3']; var numChannels = SDL3.audio_recording.currentRecordingBuffer.numberOfChannels; for (var c = 0; c < numChannels; ++c) { var channelData = SDL3.audio_recording.currentRecordingBuffer.getChannelData(c); if (channelData.length != $1) { throw 'Web Audio recording buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } if (numChannels == 1) { for (var j = 0; j < $1; ++j) { setValue($0 + (j * 4), channelData[j], 'float'); } } else { for (var j = 0; j < $1; ++j) { setValue($0 + (((j * numChannels) + c) * 4), channelData[j], 'float'); } } } },  
 176862: ($0) => { let gamepads = navigator['getGamepads'](); if (!gamepads) { return 0; } let gamepad = gamepads[$0]; if (!gamepad || !gamepad['vibrationActuator']) { return 0; } return 1; },  
 177037: ($0, $1, $2) => { let gamepads = navigator['getGamepads'](); if (!gamepads) { return 0; } let gamepad = gamepads[$0]; if (!gamepad || !gamepad['vibrationActuator']) { return 0; } gamepad['vibrationActuator']['playEffect']('dual-rumble', { 'startDelay': 0, 'duration': 3000, 'weakMagnitude': $2 / 0xFFFF, 'strongMagnitude': $1 / 0xFFFF, }); return 1; },  
 177373: ($0, $1, $2, $3) => { var w = $0; var h = $1; var pixels = $2; var canvasId = UTF8ToString($3); var canvas = document.querySelector(canvasId); var SDL3 = Module['SDL3']; if (SDL3.ctxCanvas !== canvas) { SDL3.ctx = Browser.createContext(canvas, false, true); if (!SDL3.ctx) { return false; } SDL3.ctxCanvas = canvas; } if (SDL3.w !== w || SDL3.h !== h || SDL3.imageCtx !== SDL3.ctx) { SDL3.image = SDL3.ctx.createImageData(w, h); SDL3.w = w; SDL3.h = h; SDL3.imageCtx = SDL3.ctx; } var data = SDL3.image.data; var src = pixels / 4; if (SDL3.data32Data !== data) { SDL3.data32 = new Int32Array(data.buffer); SDL3.data32Data = data; } var data32 = SDL3.data32; data32.set(HEAP32.subarray(src, src + data32.length)); SDL3.ctx.putImageData(SDL3.image, 0, 0); return true; },  
